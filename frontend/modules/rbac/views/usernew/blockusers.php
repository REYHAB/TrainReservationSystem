          ...
          <?= $this->render('usermenu') ?>
           ...
           <table id="example1" class="table table-bordered table-striped display" width="100%">
               ...
               PopoverX::begin([
                   ...
                   'toggleButton' => ['label'=>'Block', 'class'=>'btn btn-danger btn-xs'],
                   'header' => '<i class="glyphicon glyphicon-lock"></i> Confirm Block ',
                   'footer'=> Html::a('Block', ['/rbac/usernew/lockaccount','id'=>$service['id']], ['class'=>'btn btn-danger btn-xs']) .' '.
                          '  <button type="button" class="close " data-dismiss="popover-x" >cancel</button>'
               ]);

               echo "Are you sure you want to Block this account?";
