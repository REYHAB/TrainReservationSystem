...
$this->title = 'Approve Activated Users';
          ...
          <?= $this->render('usermenu') ?>
           ...
           <table id="example1" class="table table-bordered table-striped display" width="100%">
               ...
               PopoverX::begin([
                   ...
                   'toggleButton' => ['label'=>'Approval', 'class'=>'btn btn-primary btn-xs'],
                   'header' => '<i class="glyphicon glyphicon-lock"></i> Confirm Approval ',
                   'footer'=> Html::a('Approval', ['/rbac/usernew/activationapproval','id'=>$service['id']], ['class'=>'btn btn-primary btn-xs']) .' '.
                          '  <button type="button" class="close " data-dismiss="popover-x" >cancel</button>'
               ]);

               echo "Are you sure you want to approve activation of this user?";
